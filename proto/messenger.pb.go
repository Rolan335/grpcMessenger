...
var file_messenger_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x79, 0x4a, 0x73, 0x6f, 0x6e, 0x32, 0xbf, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4c, 0x0a, 0x0b, 0x49, 0x6e, 0x69, 0x74,
	...
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x3b,
...
var file_messenger_proto_depIdxs = []int32{
	0, // 0: messenger.ChatService.InitSession:input_type -> messenger.InitSessionRequest
	2, // 1: messenger.ChatService.CreateChat:input_type -> messenger.CreateChatRequest
	4, // 2: messenger.ChatService.SendMessage:input_type -> messenger.SendMessageRequest
	6, // 3: messenger.ChatService.GetHistory:input_type -> messenger.GetHistoryRequest
	1, // 4: messenger.ChatService.InitSession:output_type -> messenger.InitSessionResponse
	3, // 5: messenger.ChatService.CreateChat:output_type -> messenger.CreateChatResponse
	5, // 6: messenger.ChatService.SendMessage:output_type -> messenger.SendMessageResponse
	7, // 7: messenger.ChatService.GetHistory:output_type -> messenger.GetHistoryResponse
